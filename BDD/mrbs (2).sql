...
--
-- Client :  localhost
-- Généré le :  Jeu 07 Avril 2016 à 06:50
...
--
-- Structure de la table `mrbs_asso`
--

CREATE TABLE IF NOT EXISTS `mrbs_asso` (
`id_asso` int(11) NOT NULL,
  `nom_asso` varchar(50) DEFAULT NULL,
  `description_asso` varchar(2500) DEFAULT NULL,
  `email_asso` varchar(75) DEFAULT NULL,
  `tel_asso` varchar(10) DEFAULT NULL,
  `rue_asso` varchar(75) DEFAULT NULL,
  `codepost_asso` varchar(5) DEFAULT NULL,
  `ville_asso` varchar(30) DEFAULT NULL,
  `image_asso` varchar(75) DEFAULT NULL,
  `logo_asso` varchar(75) DEFAULT NULL
...
--
-- Structure de la table `mrbs_levelasso`
--

CREATE TABLE IF NOT EXISTS `mrbs_levelasso` (
  `id_level` int(11) NOT NULL,
  `intitule_level` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Contenu de la table `mrbs_levelasso`
--

INSERT INTO `mrbs_levelasso` (`id_level`, `intitule_level`) VALUES
(0, 'Membre'),
(1, 'Sous-directeur'),
(2, 'Directeur');
...
--
-- Structure de la table `mrbs_user_asso`
--

CREATE TABLE IF NOT EXISTS `mrbs_user_asso` (
  `id_asso` int(11) NOT NULL,
  `id_user` int(50) NOT NULL,
  `level_asso` int(5) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Index pour la table `mrbs_asso`
--
ALTER TABLE `mrbs_asso`
...
ALTER TABLE `mrbs_entry`
 ADD PRIMARY KEY (`id`), ADD KEY `idxStartTime` (`start_time`), ADD KEY `idxEndTime` (`end_time`), ADD KEY `room_id` (`room_id`), ADD KEY `repeat_id` (`repeat_id`);

--
-- Index pour la table `mrbs_levelasso`
--
ALTER TABLE `mrbs_levelasso`
...
ALTER TABLE `mrbs_room`
 ADD PRIMARY KEY (`id`), ADD KEY `idxSortKey` (`sort_key`), ADD KEY `area_id` (`area_id`);
...
--
-- Index pour la table `mrbs_user_asso`
--
ALTER TABLE `mrbs_user_asso`
 ADD PRIMARY KEY (`id_asso`,`id_user`), ADD KEY `id_user` (`id_user`), ADD KEY `level_asso` (`level_asso`);
...
--
-- AUTO_INCREMENT pour la table `mrbs_asso`
--
ALTER TABLE `mrbs_asso`
...
--
ALTER TABLE `mrbs_entry`
ADD CONSTRAINT `mrbs_entry_ibfk_1` FOREIGN KEY (`repeat_id`) REFERENCES `mrbs_repeat` (`id`),
ADD CONSTRAINT `mrbs_entry_ibfk_2` FOREIGN KEY (`room_id`) REFERENCES `mrbs_room` (`id`),
ADD CONSTRAINT `mrbs_entry_ibfk_3` FOREIGN KEY (`repeat_id`) REFERENCES `mrbs_repeat` (`id`);

--
-- Contraintes pour la table `mrbs_repeat`
--
ALTER TABLE `mrbs_repeat`
ADD CONSTRAINT `mrbs_repeat_ibfk_1` FOREIGN KEY (`room_id`) REFERENCES `mrbs_room` (`id`);

--
-- Contraintes pour la table `mrbs_room`
--
ALTER TABLE `mrbs_room`
ADD CONSTRAINT `mrbs_room_ibfk_1` FOREIGN KEY (`area_id`) REFERENCES `mrbs_area` (`id`);

--
-- Contraintes pour la table `mrbs_user_asso`
--
ALTER TABLE `mrbs_user_asso`
ADD CONSTRAINT `mrbs_user_asso_ibfk_1` FOREIGN KEY (`id_asso`) REFERENCES `mrbs_asso` (`id_asso`),
ADD CONSTRAINT `mrbs_user_asso_ibfk_2` FOREIGN KEY (`id_asso`) REFERENCES `mrbs_asso` (`id_asso`),
ADD CONSTRAINT `mrbs_user_asso_ibfk_3` FOREIGN KEY (`id_user`) REFERENCES `mrbs_users` (`id`),
ADD CONSTRAINT `mrbs_user_asso_ibfk_4` FOREIGN KEY (`level_asso`) REFERENCES `mrbs_levelasso` (`id_level`);
